...
def resnet(depth, width, num_classes):
    ...
    params = {'conv0': conv_params(3,16,3),
              ...
              'bn': bnparams(widths[1]),
              'fc': linear_params(widths[1], num_classes),
             }
    ...
    def group(o, params, stats, base, mode, stride, layers):
    ...
    def f(input, params, stats, mode, prefix=''):
        ...
        g1 = group(g0, params, stats, prefix+'group1', mode, 2, 3)
#        g2 = group(g1, params, stats, prefix+'group2', mode, 2)
        o = F.relu(batch_norm(g1, params, stats, prefix+'bn', mode))
