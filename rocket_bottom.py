...
def main():
    ...
    # option note
    if opt.beta:
        print "Warning: the structure of rocket-bottle don't support attention-transfer, please remove beta param"
        exit(1)

    if opt.student_depth != 16 and opt.gamma:
        print "Warining: now we just support rocket-bottle structure preserve the almost parameter quant with 16 depth rocket-interval"
